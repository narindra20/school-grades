package school.hei.students.endpoint.event.consumer;
...
import school.hei.students.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("school.hei.students.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "school.hei.students.service.event."
