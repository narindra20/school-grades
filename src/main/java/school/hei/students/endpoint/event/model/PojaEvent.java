...
import static school.hei.students.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.students.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "school.hei.students.event1";
  }
}
